/*
 * MAG Portfolio - Responsive jQuery Grid Plugin
 *
 * version: 1.1.0 (08 October, 2018)
 * require: jQuery v1.8+
 *
 *
 *
...
! function(e, t, n, o) {
    ...
    function i(t, n, a) {
        var r = this;
        if (e.data(t, "magportfolio")) throw new Error("magportfolio is already initialized. Destroy it before initialize again!");
        r.obj = t, r.$obj = e(t), e.data(r.obj, "magportfolio", r), n.sortToPreventGaps !== o && (n.sortByDimension = n.sortToPreventGaps, delete n.sortToPreventGaps), r.options = e.extend({}, e.fn.magportfolio.options, n, r.$obj.data("mag-options")), r.isAnimating = !0, r.defaultFilter = r.options.defaultFilter, r.registeredEvents = [], r.queue = [], r.addedWrapp = !1, e.isFunction(a) && r.registerEvent("initFinish", a, !0);
        var s = r.$obj.children();
        r.$obj.addClass("mag"), (0 === s.length || s.first().hasClass("mag-item")) && (r.wrapInner(r.obj, "mag-wrapper"), r.addedWrapp = !0), r.$ul = r.$obj.children().addClass("mag-wrapper"), r.wrapInner(r.obj, "mag-wrapper-outer"), r.wrapper = r.$obj.children(".mag-wrapper-outer"), r.blocks = r.$ul.children(".mag-item"), r.blocksOn = r.blocks, r.wrapInner(r.blocks, "mag-item-wrapper"), r.plugins = {}, e.each(i.plugins, function(e, t) {
            var n = t(r);
            n && (r.plugins[e] = n)
    ...
    e.extend(i.prototype, {
        storeData: function(t, n) {
            ...
            n = n || 0, t.each(function(t, i) {
                ...
                a.data("mag", {
                    index: n + t,
                    indexInitial: n + t,
                    wrapper: a.children(".mag-item-wrapper"),
                    widthInitial: r,
                    heightInitial: s,
                    width: r,
                    height: s,
            ...
            requestAnimationFrame(function() {
                var i = t.find("img").map(function(t, n) {
                        if (n.hasAttribute("width") && n.hasAttribute("height")) {
                            if (n.style.width = n.getAttribute("width") + "px", n.style.height = n.getAttribute("height") + "px", n.hasAttribute("data-mag-src")) return null;
                            if (null === o.checkSrc(n)) o.removeAttrImage(n);
                            else {
                                var i = e("<img>");
                                i.on("load.mag error.mag", function() {
                                    e(this).off("load.mag error.mag"), o.removeAttrImage(n)
                ...
                0 !== a ? e.each(i, function(t, i) {
                    var r = e("<img>");
                    r.on("load.mag error.mag", function() {
                        e(this).off("load.mag error.mag"), 0 === --a && n.call(o)
        ...
        display: function() {
            var e = this;
            e.width = e.$obj.outerWidth(), e.triggerEvent("initStartRead"), e.triggerEvent("initStartWrite"), e.width > 0 && (e.storeData(e.blocks), e.layoutAndAdjustment()), e.triggerEvent("initEndRead"), e.triggerEvent("initEndWrite"), e.$obj.addClass("mag-ready"), e.runQueue("delayFrame", e.delayFrame)
        },
        delayFrame: function() {
            var e = this;
            requestAnimationFrame(function() {
                e.resizeEvent(), e.triggerEvent("initFinish"), e.isAnimating = !1, e.$obj.trigger("initComplete.mag")
            })
        },
        ...
        layout: function() {
            var t = this;
            t.computeBlocks(t.filterConcat(t.defaultFilter)), "slider" === t.options.layoutMode ? (t.sliderLayoutReset(), t.sliderLayout()) : (t.mosaicLayoutReset(), t.mosaicLayout()), t.blocksOff.addClass("mag-item-off"), t.blocksOn.removeClass("mag-item-off").each(function(t, n) {
                var o = e(n).data("mag");
        ...
        filterLayout: function() {
            var t = this;
            t.blocksOff.addClass("mag-item-off"), t.blocksOn.removeClass("mag-item-off").each(function(t, n) {
                var o = e(n).data("mag");
                o.left = o.leftNew, o.top = o.topNew, n.style.left = o.left + "px", n.style.top = o.top + "px"
        ...
        filterFinish: function() {
            var e = this;
            e.isAnimating = !1, e.$obj.trigger("filterComplete.mag"), e.triggerEvent("filterFinish")
        },
        ...
        responsiveLayout: function() {
            ...
            t.blocks.each(function(t, o) {
                e.each(e(o).find("img").filter("[width][height]"), function(t, o) {
                    var i = 0;
                    e(o).parentsUntil(".mag-item").each(function(t, n) {
                        var o = e(n).width();
                        if (o > 0) return i = o, !1
                    });
        ...
        getColumnsAuto: function() {
            ...
            var t = e.blocks.first().data("mag").widthInitial + e.options.gapVertical;
        ...
        resizeMainContainer: function() {
            ...
            "alignCenter" === n.options.gridAdjustment && (t = 0, n.blocksOn.each(function(n, o) {
                ...
                n.$obj.trigger("pluginResize.mag")
            }) : n.$obj.trigger("pluginResize.mag")), n.height = a, n.triggerEvent("resizeMainContainer")) : n.triggerEvent("resizeMainContainer")
        },
        ...
        addItems: function(t, n, o) {
            var a = this;
            a.wrapInner(t, "mag-item-wrapper"), a.$ul[o](t.addClass("mag-item-loading").css({
                top: "100%",
                left: 0
                ...
                if (a.$obj.addClass("mag-updateItems"), "append" === o) a.storeData(t, a.blocks.length), e.merge(a.blocks, t);
                else {
                    a.storeData(t);
                    var n = t.length;
                    a.blocks.each(function(t, o) {
                        e(o).data("mag").index = n + t
        ...
        addItemsFinish: function(t, n) {
            var o = this;
            o.isAnimating = !1, o.$obj.removeClass("mag-updateItems"), t.removeClass("mag-item-loading"), e.isFunction(n) && n.call(o, t), o.$obj.trigger("onAfterLoadMore.mag", [t])
        },
        removeItems: function(t, n) {
            var o = this;
            o.$obj.addClass("mag-updateItems"), i["private"].modernBrowser ? t.last().one(i["private"].animationend, function() {
                ...
                o.blocks.each(function(t, a) {
                    if (n === a) {
                        ...
                        o.blocks.splice(t, 1), i["private"].modernBrowser ? (r.one(i["private"].animationend, function() {
                            r.remove()
                        }), r.addClass("mag-removeItem")) : r.remove()
                    }
                })
            }), o.blocks.each(function(t, n) {
                e(n).data("mag").index = t
        ...
        removeItemsFinish: function(t, n) {
            var o = this;
            o.isAnimating = !1, o.$obj.removeClass("mag-updateItems"), e.isFunction(n) && n.call(o, t)
        }
    }), e.fn.magportfolio = function(e, t, n) {
        return this.each(function() {
            if ("object" == typeof e || !e) return i["public"].init.call(this, e, t);
            if (i["public"][e]) return i["public"][e].call(this, t, n);
            throw new Error("Method " + e + " does not exist on jquery.magportfolio.js")
        })
    }, i.plugins = {}, e.fn.magportfolio.constructor = i
}(jQuery, window, document),
function(e, t, n, o) {
    "use strict";
    var i = e.fn.magportfolio.constructor;
    e.extend(i.prototype, {
        mosaicLayoutReset: function() {
            var t = this;
            t.blocksAreSorted = !1, t.blocksOn.each(function(n, o) {
                e(o).data("mag").pack = !1, t.options.sortByDimension && (o.style.height = "")
            }), t.freeSpaces = [{
                leftStart: 0,
...
}(jQuery, window, document), jQuery.fn.magportfolio.options = {
        filters: "",
        search: "",
        layoutMode: "grid",
        sortByDimension: !1,
        ...
        lightboxDelegate: ".mag-lightbox",
        lightboxGallery: !0,
        lightboxTitleSrc: "data-title",
        lightboxCounter: '<div class="mag-popup-lightbox-counter">{{current}} of {{total}}</div>',
        singlePageDelegate: ".mag-singlePage",
        singlePageDeeplinking: !0,
        singlePageStickyNavigation: !0,
        singlePageCounter: '<div class="mag-popup-singlePage-counter">{{current}} of {{total}}</div>',
        singlePageAnimation: "left",
        singlePageCallback: null,
        singlePageInlineDelegate: ".mag-singlePageInline",
    ...
    function(e, t, n, o) {
        ...
        i["private"] = {
            ...
            checkInstance: function(t) {
                var n = e.data(this, "magportfolio");
                if (!n) throw new Error("magportfolio is not initialized. Initialize it before calling " + t + " method!");
        ...
        }, i["private"].browserInfo(), i["private"].resize = new i["private"].publicEvents("resize.mag", 50, function() {
    ...
    function(e, t, n, o) {
        ...
        i["public"] = {
            ...
            destroy: function(t) {
                ...
                n.triggerEvent("beforeDestroy"), e.removeData(this, "magportfolio"), n.blocks.removeData("mag"), n.$obj.removeClass("mag-ready").removeAttr("style"), n.$ul.removeClass("mag-wrapper"), i["private"].resize.destroyEvent(n), n.$obj.off(".mag"), n.blocks.removeClass("mag-item-off").removeAttr("style"), n.blocks.find(".mag-item-wrapper").each(function(t, n) {
                    var o = e(n),
                        i = o.children();
            ...
            filter: function(t, n) {
                ...
                if (!a.isAnimating) {
                    if (a.isAnimating = !0, e.isFunction(n) && a.registerEvent("filterFinish", n, !0), e.isFunction(t)) {
                        if (void 0 === (o = t.call(a, a.blocks))) throw new Error("When you call magportfolio API `filter` method with a param of type function you must return the blocks that will be visible.")
                    } else {
                        if (a.options.filterDeeplinking) {
                            var r = location.href.replace(/#magrafay=(.*?)([#\?&]|$)/gi, "");
                            location.href = r + "#magrafay=" + encodeURIComponent(t), a.singlePage && a.singlePage.url && (a.singlePage.url = location.href)
                        }
            ...
            showCounter: function(t, n) {
                ...
                e.isFunction(n) && o.registerEvent("showCounterFinish", n, !0), o.elems = t, t.each(function() {
                    ...
                    t.find(".mag-filter-counter").text(n)
    ...
    function(e, t, n, o) {
        ...
        e.extend(i.prototype, {
            ...
            destroySlider: function() {
                var t = this;
                "slider" === t.options.layoutMode && (t.$obj.removeClass("mag-mode-slider"), t.$ul.removeAttr("style"), t.$ul.off(".mag"), e(n).off(".mag"), t.options.auto && t.stopSliderAuto())
            },
            ...
            enableDisableNavSlider: function() {
                var e, t, n = this;
                n.isRewindNav() || (t = n.isStartSlider() ? "addClass" : "removeClass", n.navPrev[t]("mag-nav-stop"), t = n.isEndSlider() ? "addClass" : "removeClass", n.navNext[t]("mag-nav-stop")), n.options.showPagination && (e = n.options.scrollByPage ? Math.ceil(n.sliderActive / n.cols) : n.isEndSlider() ? n.navPaginationItems.length - 1 : Math.floor(n.sliderActive / n.cols), n.navPaginationItems.removeClass("mag-nav-pagination-active").eq(e).addClass("mag-nav-pagination-active")), n.customPagination && (e = n.options.scrollByPage ? Math.ceil(n.sliderActive / n.cols) : n.isEndSlider() ? n.customPaginationItems.length - 1 : Math.floor(n.sliderActive / n.cols), n.customPaginationItems.removeClass(n.customPaginationClass).eq(e).addClass(n.customPaginationClass))
            },
            ...
            dragSlider: function() {
                function a(t) {
                    b.sliderItemsLength() || (w ? h = t : t.preventDefault(), b.options.auto && b.stopSliderAuto(), m ? e(d).one("click.mag", function() {
                        return !1
                    }) : (d = e(t.target), c = p(t).x, u = 0, f = -b.sliderActive * b.columnWidth, g = b.columnWidth * (b.blocksOn.length - b.cols), v.on(y.move, s), v.on(y.end, r), b.$obj.addClass("mag-mode-slider-dragStart")))
                }

                function r(e) {
                    b.$obj.removeClass("mag-mode-slider-dragStart"), m = !0, 0 !== u ? (d.one("click.mag", function(e) {
                        return !1
                    }), requestAnimationFrame(function() {
    ...
    function(e, t, n, o) {
        ...
        var a = e.fn.magportfolio.constructor;
        i.prototype.filterLayout = function() {
            function t() {
                n.blocks.removeClass("mag-item-on2off mag-item-off2on mag-item-on2on").each(function(t, n) {
                    var o = e(n).data("mag");
                    o.left = o.leftNew, o.top = o.topNew, n.style.left = o.left + "px", n.style.top = o.top + "px", n.style[a["private"].transform] = ""
                }), n.blocksOff.addClass("mag-item-off"), n.$obj.removeClass("mag-animation-" + n.options.animationType), n.filterFinish()
            }
            var n = this;
            n.$obj.addClass("mag-animation-" + n.options.animationType), n.blocksOn2On.addClass("mag-item-on2on").each(function(t, n) {
                var o = e(n).data("mag");
                n.style[a["private"].transform] = "translate3d(" + (o.leftNew - o.left) + "px, " + (o.topNew - o.top) + "px, 0)"
            }), n.blocksOn2Off.addClass("mag-item-on2off"), n.blocksOff2On = n.blocksOn.filter(".mag-item-off").removeClass("mag-item-off").addClass("mag-item-off2on").each(function(t, n) {
                var o = e(n).data("mag");
                n.style.left = o.leftNew + "px", n.style.top = o.topNew + "px"
            }), n.blocksOn2Off.length ? n.blocksOn2Off.last().data("mag").wrapper.one(a["private"].animationend, t) : n.blocksOff2On.length ? n.blocksOff2On.last().data("mag").wrapper.one(a["private"].animationend, t) : n.blocksOn2On.length ? n.blocksOn2On.last().one(a["private"].transitionend, t) : t(), n.resizeMainContainer()
        }, i.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("mag-animation-" + e.options.animationType)
        ...
        i.prototype.filterLayout = function() {
            function t() {
                n.wrapper[0].removeChild(o), "sequentially" === n.options.animationType && n.blocksOn.each(function(t, n) {
                    e(n).data("mag").wrapper[0].style[a["private"].animationDelay] = ""
                }), n.$obj.removeClass("mag-animation-" + n.options.animationType), n.filterFinish()
            }
            var n = this,
                o = n.$ul[0].cloneNode(!0);
            o.setAttribute("class", "mag-wrapper-helper"), n.wrapper[0].insertBefore(o, n.$ul[0]), requestAnimationFrame(function() {
                n.$obj.addClass("mag-animation-" + n.options.animationType), n.blocksOff.addClass("mag-item-off"), n.blocksOn.removeClass("mag-item-off").each(function(t, o) {
                    var i = e(o).data("mag");
                ...
                }), n.blocksOn.length ? n.blocksOn.last().data("mag").wrapper.one(a["private"].animationend, t) : n.blocksOnInitial.length ? n.blocksOnInitial.last().data("mag").wrapper.one(a["private"].animationend, t) : t(), n.resizeMainContainer()
            })
        }, i.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("mag-animation-" + e.options.animationType)
    ...
    function(e, t, n, o) {
        ...
        i.prototype.filterLayout = function() {
            function t() {
                n.wrapper[0].removeChild(o[0]), n.$obj.removeClass("mag-animation-" + n.options.animationType), n.blocks.each(function(t, n) {
                    e(n).data("mag").wrapper[0].style[a["private"].animationDelay] = ""
                }), n.filterFinish()
            }
            var n = this,
                o = n.$ul.clone(!0, !0);
            o[0].setAttribute("class", "mag-wrapper-helper"), n.wrapper[0].insertBefore(o[0], n.$ul[0]);
            var i = o.find(".mag-item").not(".mag-item-off");
            n.blocksAreSorted && n.sortBlocks(i, "top", "left"), i.children(".mag-item-wrapper").each(function(e, t) {
                t.style[a["private"].animationDelay] = 50 * e + "ms"
            }), requestAnimationFrame(function() {
                n.$obj.addClass("mag-animation-" + n.options.animationType), n.blocksOff.addClass("mag-item-off"), n.blocksOn.removeClass("mag-item-off").each(function(t, n) {
                    var o = e(n).data("mag");
                ...
                var o = n.blocksOn.length,
                    r = i.length;
                0 === o && 0 === r ? t() : o < r ? i.last().children(".mag-item-wrapper").one(a["private"].animationend, t) : n.blocksOn.last().data("mag").wrapper.one(a["private"].animationend, t), n.resizeMainContainer()
            })
        }, i.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("mag-animation-" + e.options.animationType)
    ...
    function(e, t, n, o) {
        ...
        i.prototype.filterLayout = function() {
            function t() {
                n.wrapper[0].removeChild(o), n.$obj.removeClass("mag-animation-" + n.options.animationType), n.filterFinish()
            }
            var n = this,
                o = n.$ul[0].cloneNode(!0);
            o.setAttribute("class", "mag-wrapper-helper"), n.wrapper[0].insertBefore(o, n.$ul[0]), requestAnimationFrame(function() {
    ...
    function(e, t, n, o) {
        ...
        i.prototype.init = function() {
            var e = this;
            "" != e.captionOn && ("expand" === e.captionOn || a["private"].modernBrowser || (e.parent.options.caption = e.captionOn = "minimal"), e.parent.$obj.addClass("mag-caption-active mag-caption-" + e.captionOn))
        }, i.prototype.destroy = function() {
            this.parent.$obj.removeClass("mag-caption-active mag-caption-" + this.captionOn)
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            this.parent = t, t.registerEvent("initFinish", function() {
                t.$obj.on("click.mag", ".mag-caption-defaultWrap", function(n) {
                    if (n.preventDefault(), !t.isAnimating) {
                        ...
                        if (t.$obj.addClass("mag-caption-expand-active"), a.hasClass("mag-caption-expand-open")) {
                            var l = s;
                            s = r, r = l, a.removeClass("mag-caption-expand-open")
                        }
                        i.css(r), t.$obj.one("pluginResize.mag", function() {
                            t.isAnimating = !1, t.$obj.removeClass("mag-caption-expand-active"), 0 === r.height && (a.removeClass("mag-caption-expand-open"), i.attr("style", ""))
                        }), t.layoutAndAdjustment(!0), i.css(s), requestAnimationFrame(function() {
                            a.addClass("mag-caption-expand-open"), i.css(r), t.triggerEvent("gridAdjust"), t.triggerEvent("resizeGrid")
                        })
                    }
                })
            }, !0)
        ...
        var a = e.fn.magportfolio.constructor;
        i.prototype.destroy = function() {
            this.parent.$obj.find(".mag-caption-defaultWrap").off("click.mag").parent().removeClass("mag-caption-expand-active")
        ...
        function i(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    ...
                    }), t.$obj.addClass("mag-displayType-bottomToTop"), t.blocksOn.last().one(a["private"].animationend, function() {
                        t.$obj.removeClass("mag-displayType-bottomToTop"), t.blocksOn.each(function(e, t) {
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    var n = e.Deferred();
                    t.pushQueue("delayFrame", n), t.obj.style[a["private"].animationDuration] = t.options.displayTypeSpeed + "ms", t.$obj.addClass("mag-displayType-fadeIn"), t.$obj.one(a["private"].animationend, function() {
                        t.$obj.removeClass("mag-displayType-fadeIn"), t.obj.style[a["private"].animationDuration] = "", n.resolve()
                    })
                }
            }, !0)
        }
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    var n = e.Deferred();
                    t.pushQueue("delayFrame", n), t.obj.style[a["private"].animationDuration] = t.options.displayTypeSpeed + "ms", t.$obj.addClass("mag-displayType-fadeInToTop"), t.$obj.one(a["private"].animationend, function() {
                        t.$obj.removeClass("mag-displayType-fadeInToTop"), t.obj.style[a["private"].animationDuration] = "", n.resolve()
                    })
                }
            }, !0)
        }
        ...
        function i(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    ...
                    t.pushQueue("delayFrame", n), t.blocksOn.each(function(e, n) {
                        n.style[a["private"].animationDelay] = e * t.options.displayTypeSpeed + "ms"
                    }), t.$obj.addClass("mag-displayType-sequentially"), t.blocksOn.last().one(a["private"].animationend, function() {
                        t.$obj.removeClass("mag-displayType-sequentially"), t.blocksOn.each(function(e, t) {
                            t.style[a["private"].animationDelay] = ""
                        }), n.resolve()
                    })
                }
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            ...
            n.parent = t, n.filters = e(t.options.filters), n.filterData = [], t.registerEvent("afterPlugins", function(e) {
                ...
                n.filters.each(function(t, n) {
                    var i = e(n).find(".mag-filter-item");
                    e.each(o, function(e, t) {
                        var n = i.filter('[data-filter="' + t + '"]');
                        if (n.length) return n.addClass("mag-filter-item-active").siblings().removeClass("mag-filter-item-active"), o.splice(e, 1), !1
                    })
        ...
        i.prototype.registerFilter = function() {
            ...
            t.wrap = t.filters.find(".mag-l-filters-dropdownWrap").on({
                "mouseover.mag": function() {
                    e(this).addClass("mag-l-filters-dropdownWrap-open")
                },
                "mouseleave.mag": function() {
                    e(this).removeClass("mag-l-filters-dropdownWrap-open")
                }
            }), t.filters.each(function(i, a) {
                var r = e(a),
                    s = "*",
                    l = r.find(".mag-filter-item"),
                    p = {};
                r.hasClass("mag-l-filters-dropdown") && (p.wrap = r.find(".mag-l-filters-dropdownWrap"), p.header = r.find(".mag-l-filters-dropdownHeader"), p.headerText = p.header.text()), n.$obj.magportfolio("showCounter", l), e.each(o, function(e, t) {
                    if (l.filter('[data-filter="' + t + '"]').length) return s = t, o.splice(e, 1), !1
                }), e.data(a, "filterName", s), t.filterData.push(a), t.filtersCallback(p, l.filter('[data-filter="' + s + '"]')), l.on("click.mag", function() {
                    var o = e(this);
                    if (!o.hasClass("mag-filter-item-active") && !n.isAnimating) {
                        ...
                        i.length < 1 && (i = ["*"]);
                        var r = i.join("|");
                        n.defaultFilter !== r && n.$obj.magportfolio("filter", r)
                    }
                })
            })
        }, i.prototype.filtersCallback = function(t, n) {
            e.isEmptyObject(t) || (t.wrap.trigger("mouseleave.mag"), t.headerText ? t.headerText = "" : t.header.html(n.html())), n.addClass("mag-filter-item-active").siblings().removeClass("mag-filter-item-active")
        }, i.prototype.filterFromUrl = function() {
            var e = /#magrafay=(.*?)([#\?&]|$)/gi.exec(location.href);
            null !== e && (this.parent.defaultFilter = decodeURIComponent(e[1]))
        }, i.prototype.destroy = function() {
            var e = this;
            e.filters.find(".mag-filter-item").off(".mag"), e.wrap.off(".mag")
    ...
    function(e, t, n, o) {
        ...
        e.fn.magportfolio.constructor.plugins.changeGapOnMediaQueries = function(e) {
            return new i(e)
        }
    }(jQuery, window, document),
    function(e, t, n, o) {
        ...
        function a(e) {
            var t = this;
            e.hasClass("mag-slider-inline-ready") || (e.addClass("mag-slider-inline-ready"), t.items = e.find(".mag-slider-wrapper").children(".mag-slider-item"), t.active = t.items.filter(".mag-slider-item--active").index(), t.total = t.items.length - 1, t.updateLeft(), e.find(".mag-slider-next").on("click.mag", function(e) {
                e.preventDefault(), t.active < t.total ? (t.active++, t.updateLeft()) : t.active === t.total && (t.active = 0, t.updateLeft())
            }), e.find(".mag-slider-prev").on("click.mag", function(e) {
                e.preventDefault(), t.active > 0 ? (t.active--, t.updateLeft()) : 0 === t.active && (t.active = t.total, t.updateLeft())
            }))
        }
        var r = {},
            s = e.fn.magportfolio.constructor;
        a.prototype.updateLeft = function() {
            var e = this;
            e.items.removeClass("mag-slider-item--active"), e.items.eq(e.active).addClass("mag-slider-item--active"), e.items.each(function(t, n) {
                n.style.left = t - e.active + "00%"
            })
        }, i.prototype.runInit = function() {
            var t = this;
            t.parent.$obj.find(".mag-slider-inline").not(".mag-slider-inline-ready").each(function(n, o) {
                var i = e(o),
                    r = i.find(".mag-slider-item--active").find("img")[0];
                r.hasAttribute("data-mag-src") ? t.parent.$obj.on("lazyLoad.mag", function(e, t) {
                    t.src === r.src && new a(i)
                }) : new a(i)
            })
        }, i.prototype.destroy = function() {
            var t = this;
            t.parent.$obj.find(".mag-slider-next").off("click.mag"), t.parent.$obj.find(".mag-slider-prev").off("click.mag"), t.parent.$obj.off("lazyLoad.mag"), t.parent.$obj.find(".mag-slider-inline").each(function(t, n) {
                var o = e(n);
                o.removeClass("mag-slider-inline-ready");
                var i = o.find(".mag-slider-item");
                i.removeClass("mag-slider-item--active"), i.removeAttr("style"), i.eq(0).addClass("mag-slider-item--active")
            })
    ...
    function(e, t, n, o) {
        ...
        var a = {
                loadingClass: "mag-lazyload",
                threshold: 400
            },
            r = e.fn.magportfolio.constructor,
            s = e(t);
        r["private"].lazyLoadScroll = new r["private"].publicEvents("scroll.maglazyLoad", 50), i.prototype.loadImages = function() {
            var t = this,
                n = t.parent.$obj.find("img").filter("[data-mag-src]");
            0 !== n.length && (t.screenHeight = s.height(), n.each(function(n, o) {
                var i = e(o.parentNode);
                if (t.isElementInScreen(o)) {
                    var a = o.getAttribute("data-mag-src");
                    null === t.parent.checkSrc(e("<img>").attr("src", a)) ? (t.removeLazyLoad(o, a), i.removeClass(t.options.loadingClass)) : (i.addClass(t.options.loadingClass), e("<img>").on("load.mag error.mag", function() {
            ...
            var i = this;
            t.src = n, t.removeAttribute("data-mag-src"), i.parent.removeAttrImage(t), i.parent.$obj.trigger("lazyLoad.mag", t), o && (r["private"].modernBrowser ? e(t).one(r["private"].transitionend, function() {
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            var n = this;
            n.parent = t, n.options = e.extend({}, a, n.parent.options.plugins.loadMore), n.loadMore = e(n.options.element).find(".mag-l-loadMore-link"), 0 !== n.loadMore.length && (n.loadItems = n.loadMore.find(".mag-l-loadMore-loadItems"), "0" === n.loadItems.text() && n.loadMore.addClass("mag-l-loadMore-stop"), t.registerEvent("filterStart", function(e) {
                n.populateItems().then(function() {
                    var t = n.items.filter(e).length;
                    t > 0 ? (n.loadMore.removeClass("mag-l-loadMore-stop"), n.loadItems.html(t)) : n.loadMore.addClass("mag-l-loadMore-stop")
                })
            }), n[n.options.action]())
        }
        var a = {
        ...
        i.prototype.populateItems = function() {
            ...
            return t.items ? e.Deferred().resolve() : (t.items = e(), e.ajax({
                ...
                0 !== o.length && e.each(e.parseHTML(o), function(n, o) {
                    e(o).hasClass("mag-item") ? t.items = t.items.add(o) : e.each(o.children, function(n, o) {
                        e(o).hasClass("mag-item") && (t.items = t.items.add(o))
                    })
                })
            }).fail(function() {
                t.items = null, t.loadMore.removeClass("mag-l-loadMore-loading")
            }))
            ...
            n.items.each(function(t, r) {
                ...
                return t
            }), 0 !== o.length ? n.parent.$obj.magportfolio("append", o, t) : n.loadMore.removeClass("mag-l-loadMore-loading").addClass("mag-l-loadMore-stop")
        }, i.prototype.click = function() {
            function e() {
                t.loadMore.removeClass("mag-l-loadMore-loading");
                var e, n = t.parent.defaultFilter;
                0 === (e = n && "*" !== n ? t.items.filter(n).length : t.items.length) ? t.loadMore.addClass("mag-l-loadMore-stop") : t.loadItems.html(e)
            }
            var t = this;
            t.loadMore.on("click.mag", function(n) {
                n.preventDefault(), t.parent.isAnimating || t.loadMore.hasClass("mag-l-loadMore-stop") || (t.loadMore.addClass("mag-l-loadMore-loading"), t.populateItems().then(function() {
                    t.populateInsertItems(e)
                }))
            })
        }, i.prototype.auto = function() {
            function n() {
                s || i.loadMore.hasClass("mag-l-loadMore-stop") || i.loadMore.offset().top - 200 > a.scrollTop() + a.height() || (s = !0, i.populateItems().then(function() {
            ...
            function o() {
                ...
                0 === (e = t && "*" !== t ? i.items.filter(t).length : i.items.length) ? i.loadMore.removeClass("mag-l-loadMore-loading").addClass("mag-l-loadMore-stop") : (i.loadItems.html(e), a.trigger("scroll.loadMore")), s = !1, 0 === i.items.length && (r["private"].loadMoreScroll.destroyEvent(i), i.parent.$obj.off("filterComplete.mag"))
            }
            var i = this,
                a = e(t),
                s = !1;
            r["private"].loadMoreScroll = new r["private"].publicEvents("scroll.loadMore", 100), i.parent.$obj.one("initComplete.mag", function() {
                i.loadMore.addClass("mag-l-loadMore-loading").on("click.mag", function(e) {
                    e.preventDefault()
                ...
                }), i.parent.$obj.on("filterComplete.mag", function() {
                    n()
                }), n()
            })
        }, i.prototype.destroy = function() {
            this.loadMore.off(".mag"), r["private"].loadMoreScroll && r["private"].loadMoreScroll.destroyEvent(this)
    ...
    function(e, t, n, o) {
        ...
        var a = e.fn.magportfolio.constructor,
            ...
            s = {
                init: function(t, o) {
                    var i, a = this;
                    if (a.magportfolio = t, a.type = o, a.isOpen = !1, a.options = a.magportfolio.options, "lightbox" === o && (a.magportfolio.registerEvent("resizeWindow", function() {
                            a.resizeImage()
                        }), a.localOptions = e.extend({}, r, a.magportfolio.options.plugins.lightbox)), "singlePageInline" !== o) {
                        if (a.createMarkup(), "singlePage" === o) {
                            if (a.magportfolio.registerEvent("resizeWindow", function() {
                                ...
                                var s = a.url.split("#magrafay="),
                                    l = s.shift();
                                if (e.each(s, function(t, n) {
                                        if (a.magportfolio.blocksOn.each(function(t, o) {
                                    ...
                                    a.url = l;
                                    var p = i,
                                        c = p.attr("data-mag-singlePage"),
                                        u = [];
                                    c ? u = p.closest(e(".mag-item")).find('[data-mag-singlePage="' + c + '"]') : a.magportfolio.blocksOn.each(function(t, n) {
                                        var o = e(n);
                                        o.not(".mag-item-off") && o.find(a.options.singlePageDelegate).each(function(t, n) {
                                            e(n).attr("data-mag-singlePage") || u.push(n)
                                        })
                            ...
                            a.localOptions = e.extend({}, r, a.magportfolio.options.plugins.singlePage)
                        }
                    } else {
                        if (a.height = 0, a.createMarkupSinglePageInline(), a.magportfolio.registerEvent("resizeGrid", function() {
                                a.isOpen && a.close()
                            }), a.options.singlePageInlineDeeplinking) {
                            a.url = location.href, "#" === a.url.slice(-1) && (a.url = a.url.slice(0, -1));
                            l = (s = a.url.split("#magrafayi=")).shift();
                            e.each(s, function(t, n) {
                                if (a.magportfolio.blocksOn.each(function(t, o) {
                                        var r = e(o).find(a.options.singlePageInlineDelegate + '[href="' + n + '"]');
                                        if (r.length) return i = r, !1
                                    }), i) return !1
                            }), i && a.magportfolio.registerEvent("initFinish", function() {
                                a.openSinglePageInline(a.magportfolio.blocksOn, i[0])
                            }, !0)
                        }
                        a.localOptions = e.extend({}, r, a.magportfolio.options.plugins.singlePageInline)
                    }
                },
                createMarkup: function() {
                    var t = this,
                        o = "";
                    "singlePage" === t.type && "left" !== t.options.singlePageAnimation && (o = " mag-popup-singlePage-" + t.options.singlePageAnimation), t.wrap = e("<div/>", {
                        "class": "mag-popup-wrap mag-popup-" + t.type + o,
                        "data-action": "lightbox" === t.type ? "close" : ""
                    }).on("click.mag", function(n) {
                        if (!t.stopEvents) {
                            var o = e(n.target).attr("data-action");
                            t[o] && (t[o](), n.preventDefault())
                        }
                    }), "singlePage" === t.type ? (t.contentWrap = e("<div/>", {
                        "class": "mag-popup-content-wrap"
                    }).appendTo(t.wrap), "ios" === a["private"].browser && t.contentWrap.css("overflow", "auto"), t.content = e("<div/>", {
                        "class": "mag-popup-content"
                    }).appendTo(t.contentWrap)) : t.content = e("<div/>", {
                        "class": "mag-popup-content"
                    }).appendTo(t.wrap), e("<div/>", {
                        "class": "mag-popup-loadingBox"
                    }).appendTo(t.wrap), "ie8" === a["private"].browser && (t.bg = e("<div/>", {
                        "class": "mag-popup-ie8bg",
                        "data-action": "lightbox" === t.type ? "close" : ""
                    }).appendTo(t.wrap)), "singlePage" === t.type && !1 === t.options.singlePageStickyNavigation ? t.navigationWrap = e("<div/>", {
                        "class": "mag-popup-navigation-wrap"
                    }).appendTo(t.contentWrap) : t.navigationWrap = e("<div/>", {
                        "class": "mag-popup-navigation-wrap"
                    }).appendTo(t.wrap), t.navigation = e("<div/>", {
                        "class": "mag-popup-navigation"
                    }).appendTo(t.navigationWrap), t.closeButton = e("<div/>", {
                        "class": "mag-popup-close",
                        title: "Close (Esc arrow key)",
                        "data-action": "close"
                    }).appendTo(t.navigation), t.nextButton = e("<div/>", {
                        "class": "mag-popup-next",
                        title: "Next (Right arrow key)",
                        "data-action": "next"
                    }).appendTo(t.navigation), t.prevButton = e("<div/>", {
                        "class": "mag-popup-prev",
                        title: "Previous (Left arrow key)",
                        "data-action": "prev"
                    }).appendTo(t.navigation), "singlePage" === t.type && (t.options.singlePageCounter && (t.counter = e(t.options.singlePageCounter).appendTo(t.navigation), t.counter.text("")), t.content.on("click.mag", t.options.singlePageDelegate, function(e) {
                        e.preventDefault();
                    ...
                    }), t.contentWrap.on("mousewheel.mag DOMMouseScroll.mag", function(e) {
                        e.stopImmediatePropagation()
                    })), e(n).on("keydown.mag", function(e) {
                ...
                createMarkupSinglePageInline: function() {
                    var t = this;
                    t.wrap = e("<div/>", {
                        "class": "mag-popup-singlePageInline"
                    }).on("click.mag", function(n) {
                        if (!t.stopEvents) {
                            var o = e(n.target).attr("data-action");
                ...
                destroy: function() {
                    var t = this,
                        o = e("body");
                    e(n).off("keydown.mag"), o.off("click.mag", t.options.lightboxDelegate), o.off("click.mag", t.options.singlePageDelegate), t.content.off("click.mag", t.options.singlePageDelegate), t.magportfolio.$obj.off("click.mag", t.options.singlePageInlineDelegate), t.magportfolio.$obj.off("click.mag", t.options.lightboxDelegate), t.magportfolio.$obj.off("click.mag", t.options.singlePageDelegate), t.magportfolio.$obj.removeClass("mag-popup-isOpening"), t.magportfolio.$obj.find(".mag-item").removeClass("mag-singlePageInline-active"), t.wrap.remove()
                },
                openLightbox: function(o, i) {
                    ...
                    if (!s.isOpen) {
                        ...
                        }), s.wrap.addClass("mag-popup-transitionend"), s.wrap.show(), r = s.dataArray[s.current], s[r.type](r)
                    }
                },
                openSinglePage: function(o, i) {
                    var r, s = this,
                        ...
                        p = [];
                    if (!s.isOpen) {
                        if (s.magportfolio.singlePageInline && s.magportfolio.singlePageInline.isOpen && s.magportfolio.singlePageInline.close(), s.isOpen = !0, s.stopEvents = !1, s.dataArray = [], s.current = null, null === (r = i.getAttribute("href"))) throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                        if (e.each(o, function(t, n) {
                                ...
                                e("html").css({
                                    overflow: "hidden",
                                    marginRight: t.innerWidth - e(n).width()
                                }), s.wrap.addClass("mag-popup-transitionend"), s.options.singlePageStickyNavigation && (s.wrap.addClass("mag-popup-singlePage-sticky"), s.navigationWrap.width(s.contentWrap[0].clientWidth)), --s.finishOpen <= 0 && s.updateSinglePageIsOpen.call(s)
                            }), "ie8" !== a["private"].browser && "ie9" !== a["private"].browser || (e("html").css({
                                overflow: "hidden",
                                marginRight: t.innerWidth - e(n).width()
                            }), s.wrap.addClass("mag-popup-transitionend"), s.options.singlePageStickyNavigation && (s.navigationWrap.width(s.contentWrap[0].clientWidth), setTimeout(function() {
                                s.wrap.addClass("mag-popup-singlePage-sticky")
                            }, 1e3)), s.finishOpen--), s.wrap.addClass("mag-popup-loading"), s.wrap.offset(), s.wrap.addClass("mag-popup-singlePage-open"), s.options.singlePageDeeplinking && (s.url = s.url.split("#magrafay=")[0], location.href = s.url + "#magrafay=" + s.dataArray[s.current].url), e.isFunction(s.options.singlePageCallback) && s.options.singlePageCallback.call(s, s.dataArray[s.current].url, s.dataArray[s.current].element), "ios" === a["private"].browser) {
                ...
                openSinglePageInline: function(n, o, i) {
                    var a, r, s, l = this;
                    if (i = i || !1, l.fromOpen = i, l.storeBlocks = n, l.storeCurrentBlock = o, l.isOpen) return r = l.magportfolio.blocksOn.index(e(o).closest(".mag-item")), void(l.dataArray[l.current].url !== o.getAttribute("href") || l.current !== r ? l.magportfolio.singlePageInline.close("open", {
                        blocks: n,
                        currentBlock: o,
                        fromOpen: !0
                    }) : l.close());
                    ...
                    if (s = e(o).closest(".mag-item")[0], n.each(function(e, t) {
                            s === t && (l.current = e)
                        }), l.dataArray[l.current] = {
                            url: a,
                            element: o
                        }, e(l.dataArray[l.current].element).parents(".mag-item").addClass("mag-singlePageInline-active"), l.counterTotal = n.length, l.wrap.insertBefore(l.magportfolio.wrapper), l.topDifference = 0, "top" === l.options.singlePageInlinePosition) l.blocksToMove = n, l.top = 0;
                    else if ("bottom" === l.options.singlePageInlinePosition) l.blocksToMove = e(), l.top = l.magportfolio.height;
                    else if ("above" === l.options.singlePageInlinePosition) {
                        var p = e(n[l.current]),
                            c = (u = p.data("mag").top) + p.height();
                        ...
                        var u = (p = e(n[l.current])).data("mag").top,
                            c = u + p.height();
                    ...
                    if (l.wrap[0].style.height = l.wrap.outerHeight(!0) + "px", l.deferredInline = e.Deferred(), l.options.singlePageInlineInFocus) {
                        ...
                        var d = l.magportfolio.$obj.offset().top + l.top - 100;
                    ...
                    l.magportfolio.$obj.addClass("mag-popup-singlePageInline-open"), l.wrap.css({
                        top: l.top
                    }), l.options.singlePageInlineDeeplinking && (l.url = l.url.split("#magrafayi=")[0], location.href = l.url + "#magrafayi=" + l.dataArray[l.current].url), e.isFunction(l.options.singlePageInlineCallback) && l.options.singlePageInlineCallback.call(l, l.dataArray[l.current].url, l.dataArray[l.current].element)
                },
                resizeSinglePageInline: function() {
                    var e = this;
                    e.height = 0 === e.top || e.top === e.magportfolio.height ? e.wrap.outerHeight(!0) : e.wrap.outerHeight(!0) - e.options.gapHorizontal, e.height += e.topDifference, e.storeBlocks.each(function(e, t) {
                    ...
                    }), e.magportfolio.obj.style.height = e.magportfolio.height + e.height + "px"
                },
                revertResizeSinglePageInline: function() {
                    var t = this;
                    t.deferredInline = e.Deferred(), t.storeBlocks.each(function(e, t) {
                        a["private"].modernBrowser ? t.style[a["private"].transform] = "" : t.style.marginTop = ""
                    }), t.magportfolio.obj.style.height = t.magportfolio.height + "px"
                },
                ...
                updateSinglePage: function(t, n, o) {
                    var i, a = this;
                    a.content.addClass("mag-popup-content").removeClass("mag-popup-content-basic"), !1 === o && a.content.removeClass("mag-popup-content").addClass("mag-popup-content-basic"), a.counter && (i = e(a.getCounterMarkup(a.options.singlePageCounter, a.current + 1, a.counterTotal)), a.counter.text(i.text())), a.fromAJAX = {
                        html: t,
                        scripts: n
                ...
                updateSinglePageIsOpen: function() {
                    var e, t = this;
                    t.wrap.addClass("mag-popup-ready"), t.wrap.removeClass("mag-popup-loading"), t.content.html(t.fromAJAX.html), t.fromAJAX.scripts && t.appendScriptsToWrap(t.fromAJAX.scripts), t.fromAJAX = {}, t.magportfolio.$obj.trigger("updateSinglePageStart.mag"), (e = t.content.find(".mag-slider")).length ? (e.find(".mag-slider-item").addClass("mag-item"), t.slider = e.magportfolio({
                        layoutMode: "slider",
                        mediaQueries: [{
                            width: 1,
                            cols: 1
                        ...
                        caption: "",
                        coverRatio: ""
                    })) : t.slider = null, t.checkForSocialLinks(t.content), t.magportfolio.$obj.trigger("updateSinglePageComplete.mag")
                },
                checkForSocialLinks: function(e) {
                    var t = this;
                    t.createFacebookShare(e.find(".mag-social-fb")), t.createTwitterShare(e.find(".mag-social-twitter")), t.createGooglePlusShare(e.find(".mag-social-googleplus")), t.createPinterestShare(e.find(".mag-social-pinterest"))
                },
                ...
                updateSinglePageInline: function(e, t) {
                    var n = this;
                    n.content.html(e), t && n.appendScriptsToWrap(t), n.magportfolio.$obj.trigger("updateSinglePageInlineStart.mag"), 0 !== n.localOptions.delay ? setTimeout(function() {
                        n.singlePageInlineIsOpen.call(n)
                    }, n.localOptions.delay) : n.singlePageInlineIsOpen.call(n)
                },
                singlePageInlineIsOpen: function() {
                    function e() {
                        t.wrap.addClass("mag-popup-singlePageInline-ready"), t.wrap[0].style.height = "", t.resizeSinglePageInline(), t.magportfolio.$obj.trigger("updateSinglePageInlineComplete.mag")
                    }
                    var t = this;
                    t.magportfolio.loadImages(t.wrap, function() {
                        var n = t.content.find(".mag-slider");
                        n.length ? (n.find(".mag-slider-item").addClass("mag-item"), n.one("initComplete.mag", function() {
                            t.deferredInline.done(e)
                        }), n.on("pluginResize.mag", function() {
                            t.deferredInline.done(e)
                        }), t.slider = n.magportfolio({
                            layoutMode: "slider",
                            displayType: "default",
                            mediaQueries: [{
                                width: 1,
                ...
                isImage: function(t) {
                    var n = this;
                    new Image;
                    n.tooggleLoading(!0), n.magportfolio.loadImages(e('<div><img src="' + t.src + '"></div>'), function() {
                ...
                updateSelfHostedVideo: function(e, t, n) {
                    var o, i = this;
                    i.wrap.addClass("mag-popup-lightbox-isIframe");
                    var a = '<div class="mag-popup-lightbox-iframe"><video controls="controls" height="auto" style="width: 100%">';
                    ...
                    a += 'Your browser does not support the video tag.</video><div class="mag-popup-lightbox-bottom">' + (t ? '<div class="mag-popup-lightbox-title">' + t + "</div>" : "") + n + "</div></div>", i.content.html(a), i.wrap.addClass("mag-popup-ready"), i.preloadNearbyImages()
                },
                updateSelfHostedAudio: function(e, t, n) {
                    var o = this;
                    o.wrap.addClass("mag-popup-lightbox-isIframe");
                    var i = '<div class="mag-popup-lightbox-iframe"><div class="mag-misc-video"><audio controls="controls" height="auto" style="width: 75%"><source src="' + e + '" type="audio/mpeg">Your browser does not support the audio tag.</audio></div><div class="mag-popup-lightbox-bottom">' + (t ? '<div class="mag-popup-lightbox-title">' + t + "</div>" : "") + n + "</div></div>";
                    o.content.html(i), o.wrap.addClass("mag-popup-ready"), o.preloadNearbyImages()
                },
                updateVideoMarkup: function(e, t, n) {
                    var o = this;
                    o.wrap.addClass("mag-popup-lightbox-isIframe");
                    var i = '<div class="mag-popup-lightbox-iframe"><iframe src="' + e + '" frameborder="0" allowfullscreen scrolling="no"></iframe><div class="mag-popup-lightbox-bottom">' + (t ? '<div class="mag-popup-lightbox-title">' + t + "</div>" : "") + n + "</div></div>";
                    o.content.html(i), o.wrap.addClass("mag-popup-ready"), o.preloadNearbyImages()
                },
                updateImagesMarkup: function(e, t, n) {
                    var o = this;
                    o.wrap.removeClass("mag-popup-lightbox-isIframe");
                    var i = '<div class="mag-popup-lightbox-figure"><img src="' + e + '" class="mag-popup-lightbox-img" ' + o.dataActionImg + ' /><div class="mag-popup-lightbox-bottom">' + (t ? '<div class="mag-popup-lightbox-title">' + t + "</div>" : "") + n + "</div></div>";
                    o.content.html(i), o.wrap.addClass("mag-popup-ready"), o.resizeImage(), o.preloadNearbyImages()
                },
                next: function() {
                    var e = this;
                    e[e.type + "JumpTo"](1)
                ...
                singlePageJumpTo: function(t) {
                    var n = this;
                    n.current = n.getIndex(n.current + t), e.isFunction(n.options.singlePageCallback) && (n.resetWrap(), n.contentWrap.scrollTop(0), n.wrap.addClass("mag-popup-loading"), n.slider && a["private"].resize.destroyEvent(e.data(n.slider[0], "magportfolio")), n.options.singlePageCallback.call(n, n.dataArray[n.current].url, n.dataArray[n.current].element), n.options.singlePageDeeplinking && (location.href = n.url + "#magrafay=" + n.dataArray[n.current].url))
                },
                resetWrap: function() {
                    var e = this;
                ...
                close: function(n, o) {
                    function i() {
                        s.slider && a["private"].resize.destroyEvent(e.data(s.slider[0], "magportfolio")), s.content.html(""), s.wrap.detach(), s.magportfolio.$obj.removeClass("mag-popup-singlePageInline-open mag-popup-singlePageInline-close"), "promise" === n && e.isFunction(o.callback) && o.callback.call(s.magportfolio)
                    }
                    ...
                    var s = this;
                    s.isOpen = !1, "singlePageInline" === s.type ? "open" === n ? (s.wrap.removeClass("mag-popup-singlePageInline-ready"), e(s.dataArray[s.current].element).closest(".mag-item").removeClass("mag-singlePageInline-active"), s.openSinglePageInline(o.blocks, o.currentBlock, o.fromOpen)) : (s.height = 0, s.revertResizeSinglePageInline(), s.wrap.removeClass("mag-popup-singlePageInline-ready"), s.magportfolio.$obj.addClass("mag-popup-singlePageInline-close"), s.magportfolio.$obj.find(".mag-item").removeClass("mag-singlePageInline-active"), a["private"].modernBrowser ? s.wrap.one(a["private"].transitionend, function() {
                        r()
                    }) : r()) : "singlePage" === s.type ? (s.resetWrap(), e(t).scrollTop(s.scrollTop), s.stopScroll = !0, s.wrap.removeClass("mag-popup-ready mag-popup-transitionend mag-popup-singlePage-open mag-popup-singlePage-sticky"), e("html").css({
                        overflow: "",
                        marginRight: "",
                        position: ""
                    }), "ie8" !== a["private"].browser && "ie9" !== a["private"].browser || (s.slider && a["private"].resize.destroyEvent(e.data(s.slider[0], "magportfolio")), s.content.html(""), s.wrap.detach()), s.wrap.one(a["private"].transitionend, function() {
                        s.slider && a["private"].resize.destroyEvent(e.data(s.slider[0], "magportfolio")), s.content.html(""), s.wrap.detach()
                    })) : (l = !1, s.originalStyle ? e("html").attr("style", s.originalStyle) : e("html").css({
                        overflow: "",
                        marginRight: ""
                    }), e(t).scrollTop(s.scrollTop), s.slider && a["private"].resize.destroyEvent(e.data(s.slider[0], "magportfolio")), s.content.html(""), s.wrap.detach())
                },
                tooggleLoading: function(e) {
                    var t = this;
                    t.stopEvents = e, t.wrap[e ? "addClass" : "removeClass"]("mag-popup-loading")
                },
                resizeImage: function() {
                    if (this.isOpen) {
                        var n = this.content.find("img"),
                            o = n.parent(),
                            i = e(t).height() - (o.outerHeight(!0) - o.height()) - this.content.find(".mag-popup-lightbox-bottom").outerHeight(!0);
                        n.css("max-height", i + "px")
                    }
                },
                preloadNearbyImages: function() {
                    for (var e = this, t = [e.getIndex(e.current + 1), e.getIndex(e.current + 2), e.getIndex(e.current + 3), e.getIndex(e.current - 1), e.getIndex(e.current - 2), e.getIndex(e.current - 3)], n = t.length - 1; n >= 0; n--) "isImage" === e.dataArray[t[n]].type && e.magportfolio.checkSrc(e.dataArray[t[n]])
                }
            },
            l = !1,
            p = !1,
        ...
        i.prototype.run = function() {
            var t = this,
                o = t.parent,
                i = e(n.body);
            o.lightbox = null, o.options.lightboxDelegate && !p && (p = !0, o.lightbox = Object.create(s), o.lightbox.init(o, "lightbox"), i.on("click.mag", o.options.lightboxDelegate, function(n) {
                n.preventDefault();
                var i = e(this),
                    a = i.attr("data-mag-lightbox"),
                    r = t.detectScope(i),
                    s = r.data("magportfolio"),
                    l = [];
                s ? s.blocksOn.each(function(t, n) {
                    var i = e(n);
                    i.not(".mag-item-off") && i.find(o.options.lightboxDelegate).each(function(t, n) {
                        a ? e(n).attr("data-mag-lightbox") === a && l.push(n) : l.push(n)
                    })
                }) : l = a ? r.find(o.options.lightboxDelegate + "[data-mag-lightbox=" + a + "]") : r.find(o.options.lightboxDelegate), o.lightbox.openLightbox(l, i[0])
            })), o.singlePage = null, o.options.singlePageDelegate && !c && (c = !0, o.singlePage = Object.create(s), o.singlePage.init(o, "singlePage"), i.on("click.mag", o.options.singlePageDelegate, function(n) {
                n.preventDefault();
                var i = e(this),
                    a = i.attr("data-mag-singlePage"),
                    r = t.detectScope(i),
                    s = r.data("magportfolio"),
                    l = [];
                s ? s.blocksOn.each(function(t, n) {
                    var i = e(n);
                    i.not(".mag-item-off") && i.find(o.options.singlePageDelegate).each(function(t, n) {
                        a ? e(n).attr("data-mag-singlePage") === a && l.push(n) : l.push(n)
                    })
                }) : l = a ? r.find(o.options.singlePageDelegate + "[data-mag-singlePage=" + a + "]") : r.find(o.options.singlePageDelegate), o.singlePage.openSinglePage(l, i[0])
            })), o.singlePageInline = null, o.options.singlePageInlineDelegate && (o.singlePageInline = Object.create(s), o.singlePageInline.init(o, "singlePageInline"), o.$obj.on("click.mag", o.options.singlePageInlineDelegate, function(t) {
                t.preventDefault();
                var n = e.data(this, "mag-locked"),
                    i = e.data(this, "mag-locked", +new Date);
                (!n || i - n > 300) && o.singlePageInline.openSinglePageInline(o.blocksOn, this)
            }))
        }, i.prototype.detectScope = function(t) {
            var o, i, a;
            return (o = t.closest(".mag-popup-singlePageInline")).length ? (a = t.closest(".mag", o[0]), a.length ? a : o) : (i = t.closest(".mag-popup-singlePage")).length ? (a = t.closest(".mag", i[0]), a.length ? a : i) : (a = t.closest(".mag"), a.length ? a : e(n.body))
        }, i.prototype.destroy = function() {
            var t = this.parent;
            e(n.body).off("click.mag"), p = !1, c = !1, t.lightbox && t.lightbox.destroy(), t.singlePage && t.singlePage.destroy(), t.singlePageInline && t.singlePageInline.destroy()
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            ...
            var o = null;
            n.searchInput.on("keyup.mag paste.mag", function(t) {
                t.preventDefault();
                var i = e(this);
                clearTimeout(o), o = setTimeout(function() {
                    n.runEvent.call(n, i)
                }, 350)
            }), n.searchNothing = n.searchInput.siblings(".mag-search-nothing").detach(), n.searchNothingHeight = null, n.searchNothingHTML = n.searchNothing.html(), n.searchInput.siblings(".mag-search-icon").on("click.mag", function(t) {
        ...
        i.prototype.runEvent = function(t) {
            var n = this,
                ...
                i = t.data("searchData"),
                a = new RegExp(o, "i");
            i.value === o || n.parent.isAnimating || (i.value = o, o.length > 0 ? t.attr("value", o) : t.removeAttr("value"), n.parent.$obj.magportfolio("filter", function(t) {
            ...
            var t = this;
            t.searchInput.off(".mag"), t.searchInput.next(".mag-search-icon").off(".mag"), t.searchInput.each(function(t, n) {
                e.removeData(n)
            })
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            ...
            o.length > 0 && (n.parent.customPagination = o, n.parent.customPaginationItems = o.children(), n.parent.customPaginationClass = n.options.paginationClass, n.parent.customPaginationItems.on("click.mag", function(t) {
        ...
        var a = {
                pagination: "",
                paginationClass: "mag-pagination-active"
            },
            r = e.fn.magportfolio.constructor;
        i.prototype.sliderMarkup = function() {
            var t = this;
            t.sliderStopEvents = !1, t.sliderActive = 0, t.$obj.one("initComplete.mag", function() {
                t.$obj.addClass("mag-mode-slider")
            }), t.nav = e("<div/>", {
                "class": "mag-nav"
            }), t.nav.on("click.mag", "[data-slider-action]", function(n) {
                ...
                "class": "mag-nav-pagination"
            }).appendTo(t.nav)), (t.controls || t.navPagination) && t.nav.appendTo(t.$obj), t.updateSliderPagination(), t.options.auto && (t.options.autoPauseOnHover && (t.mouseIsEntered = !1, t.$obj.on("mouseenter.mag", function(e) {
                t.mouseIsEntered = !0, t.stopSliderAuto()
            }).on("mouseleave.mag", function(e) {
            ...
            var e = this;
            e.parent.customPaginationItems && e.parent.customPaginationItems.off(".mag"), (e.parent.controls || e.parent.navPagination) && (e.parent.nav.off(".mag"), e.parent.nav.remove())
    ...
    function(e, t, n, o) {
        ...
        function i(t) {
            var n = this;
            n.parent = t, n.options = e.extend({}, a, n.parent.options.plugins.sort), n.element = e(n.options.element), 0 !== n.element.length && (n.sort = "", n.sortBy = "string:asc", n.element.on("click.mag", ".mag-sort-item", function(o) {
                o.preventDefault(), n.target = o.target, e(n.target).hasClass("mag-l-dropdown-item--active") || t.isAnimating || (n.processSort(), t.$obj.magportfolio("filter", t.defaultFilter))
            }), t.registerEvent("triggerSort", function() {
                n.target && (n.processSort(), t.$obj.magportfolio("filter", t.defaultFilter))
            }), n.dropdownWrap = n.element.find(".mag-l-dropdown-wrap").on({
                "mouseover.mag": function() {
                    e(this).addClass("mag-l-dropdown-wrap--open")
                },
                "mouseleave.mag": function() {
                    e(this).removeClass("mag-l-dropdown-wrap--open")
                }
            }), n.dropdownHeader = n.element.find(".mag-l-dropdown-header"))
        }
        var a = {
                element: ""
            },
        ...
        i.prototype.processSort = function() {
            ...
            if ("int" === a[0] ? r = "int" : "float" === a[0] && (r = "float"), "desc" === a[1] && (s = -1), t.sort) {
                ...
                var p = []; - 1 === s && (n.blocks.each(function(t, n) {
                    p.push(e(n).data("mag").indexInitial)
                }), p.sort(function(e, t) {
                    return t - e
            ...
            n.sortBlocks(n.blocks, "index"), t.dropdownWrap.trigger("mouseleave.mag");
            var c = e(t.target),
                u = e(t.target).parent();
            u.hasClass("mag-l-dropdown-list") ? (t.dropdownHeader.html(c.html()), c.addClass("mag-l-dropdown-item--active").siblings(".mag-l-dropdown-item").removeClass("mag-l-dropdown-item--active")) : u.hasClass("mag-l-direction") && (0 === c.index() ? u.addClass("mag-l-direction--second").removeClass("mag-l-direction--first") : u.addClass("mag-l-direction--first").removeClass("mag-l-direction--second"))
        }, i.prototype.destroy = function() {
            this.element.off("click.mag")
